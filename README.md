...
**[Description]** 用CNN学习一个deblur用的prior, 用来提供输入图像是否模糊的先验知识, 把该prior加入目标函数, 之后用迭代的方法求解优化函数 <Br>
...
**[Description]** 较早用CNN做图像滤波增强的paper之一, 使用了dilation conv提取全局信息. <Br>
...
**[Description]** 大致浏览, 用CNN预测guided filter中的系数A和b. <Br>
...
**[Description]** 大名鼎鼎的引导滤波, 可用在去噪, 融合, 联合上采样, matting, 图像增强等多种任务中. 速度快, 效果好. <Br>
...
**[Description]** 用拉普拉斯金字塔做图像增强, tone mapping等. <Br>
